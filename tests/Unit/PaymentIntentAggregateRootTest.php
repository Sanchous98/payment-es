...
describe('payment authorize', function () {
    test('payment is authorized successfully by payment method', function (BillingAddress $billingAddress, SourceInterface $source) {
    ...
    test('cannot authorize on suspended payment method', function (BillingAddress $billingAddress, SourceInterface $source) {
        $paymentMethod = PaymentMethodAggregateRoot::reconstituteFromEvents(
            new IntId(1),
            generator([
                new PaymentMethodCreated($billingAddress, $source),
    ...
    test('cannot authorize on failed payment method', function (BillingAddress $billingAddress, SourceInterface $source) {
        $paymentMethod = PaymentMethodAggregateRoot::reconstituteFromEvents(
            new IntId(1),
            generator([
                new PaymentMethodCreated($billingAddress, $source),
    ...
    test('cannot authorize on not approved payment method', function (BillingAddress $billingAddress, SourceInterface $source) {
        $paymentMethod = PaymentMethodAggregateRoot::reconstituteFromEvents(
            new IntId(1),
            generator([
                new PaymentMethodCreated($billingAddress, $source),
