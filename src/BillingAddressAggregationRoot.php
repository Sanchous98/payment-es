...
class BillingAddressAggregationRoot implements AggregateRoot
{
    ...
    protected function applyBillingAddressPlanCreated(BillingAddressCreated $event): void
    {
    ...
    protected function applyBillingAddressPlanUpdated(BillingAddressUpdated $event): void
    {
        $this->address->update(
            $event->firstName,
            $event->lastName,
